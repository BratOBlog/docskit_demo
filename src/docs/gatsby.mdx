...
![Gatsby folder sructure](./src/images/components.png)
...
![Components](./src/@platformos/gatsby-theme-platformos-docskit/images/components.png)
...
Netlify can host the Gatsby app created. Deploying the application needs only to have a Netlify account created and setup properly.
Netlify keeps track of the Github repository and either does automatic deployment on the repo change or it can be set to have this feautre locked and deploy manually.

Atuomatic deployment workflow is suitable with CMS added where users can add content and the deployment follows.

[Netlify documentation](https://docs.netlify.com/)

Example website deployed to Netlify
